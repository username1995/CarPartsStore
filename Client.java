...
public class Client {
    ...
    public void testPobieraniaKlienta() throws IOException, ClassNotFoundException{
		...
		//os.writeObject(k);
		//os.flush();
		System.out.println((Klient)is.readObject());
	}
    
    public void testPobieraniaCzesci() throws IOException, ClassNotFoundException{
		Czesc k = new Czesc();
		os.writeObject("/pobierz");
		os.flush();
		//os.writeObject(k);
		//os.flush();
		System.out.println((Czesc)is.readObject());
	}
